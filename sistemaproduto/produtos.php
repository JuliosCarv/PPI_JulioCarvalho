...
$tabela = "produto";
$order = "nome";
$produtos = buscar($connect, $tabela, 1, $order, ["id_prod", "nome", "descricao", "preco", "quant_estoque", "categoria", "imagem"]);
?>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="\PPI_ColletoSports_JulioCarvalhoERRO/index.php">
                            Sair
                        </a>
                    </li>
                </ul>
...
<script src="/docs/4.1/assets/js/vendor/popper.min.js"></script>
<script src="/docs/4.1/dist/js/bootstrap.min.js"></script>
